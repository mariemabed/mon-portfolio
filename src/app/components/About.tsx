...
export default function About() {
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">   {/* ← Plus étroit pour mieux centrer */}
        ...
        <div className="space-y-8">
          ...
          {/* Card 1 */}
          <div className="group relative p-8 rounded-2xl bg-white shadow-md border border-gray-100 overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
            ...
            <p className="relative text-gray-700 leading-relaxed text-lg text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-6">
            {highlights.map((item, i) => (
              <div
                key={i}
                className="flex items-center gap-2 text-sm text-gray-700 bg-white px-5 py-2.5 rounded-xl shadow-sm border border-gray-100 hover:border-[#6D28D9]/30 hover:bg-[#6D28D9]/5 transition"
              >
